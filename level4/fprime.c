...
Escriba un programa que reciba un entero positivo y muestre sus factores primos en la salida estándar,
seguido de un salto de línea.

Los factores deben mostrarse en orden ascendente y separados por '*', para que
